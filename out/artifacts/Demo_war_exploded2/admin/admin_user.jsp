...
<body class="bootstrap-admin-with-small-navbar">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<jsp:include page="/page.jsp">
							<jsp:param value="user?method=list" name="url"/>
						</jsp:include>
						<br>
					</div>
				</div>
    ...
    function showInfo2(uid,account,name,phone,lendNum,maxNum) {
		console.log(lendNum);
		console.log(maxNum);
        ...
        document.getElementById("updlendNum").value = lendNum;
        document.getElementById("updmaxNum").value = maxNum;
    }
    function deleteUser(uid) {
    	con=confirm("是否删除?");
    	/*if(con==true){
    		location.href = "/Demo_war_exploded/user?method=delete&uid="+uid;
    	}*/
		$.post("user_delete",{uid:uid},function (data){
			if(data=="ok"){
				location.reload();
				/*layer.msg("删除成功",{time:800},function (){
					//location.reload();
					//location.href = "/Demo_war_exploded/user?method=list";
	...
	<!-- 修改模态框（Modal） -->
	<form class="form-horizontal" method="post" onsubmit="updUser()"
		action="/Demo_war_exploded/user?method=update">
		<!--保证样式水平不混乱-->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updlendNum"
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updmaxNum"
	...
	<!--------------------------------------添加的模糊框------------------------>
	<form class="form-horizontal" method="post" onsubmit="adUser()"
		action="/Demo_war_exploded/user?method=add">
		<!--保证样式水平不混乱-->
		<!-- 模态框（Modal） -->
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="account"
									id="addAcount" required="required" placeholder="请输入账号">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="name"
									id="addName" required="required" placeholder="请输入姓名">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="password" class="form-control" name="password"
									id="addPsw" required="required" placeholder="请输入密码">
								<label class="control-label" for="addPress"
									style="display: none;"></label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="lendNum"
									id="addLend" required="required" placeholder="请输入可借阅天数">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="maxNum"
									id="addMax" required="required" placeholder="请输入最大可借数">
								<label class="control-label" for="addPress"
									style="display: none;"></label>
							</div>
						</div>
	...
	<script>
		function adUser(){
			$.post("user_add",{account:document.getElementById("addAcount").value,name:document.getElementById("addName").value,phone:document.getElementById("addPhone").value,
			lendNum:document.getElementById("addLend").value,maxNum:document.getElementById("addMax").value ,
			password:document.getElementById('addPsw').value,role:document.getElementById('addRole').value},function (data){
				if(data=="ok"){
					//console.log(document.getElementById('addBookName').value);
					//console.log(document.getElementById('addBookType').value);
					location.reload();
				}
			});
		}
		...
		function updUser(){
			//console.log(1)
			//alert(1);
			$.post("user_update",{uid:document.getElementById('updateuid').value
				,name:document.getElementById("updatename").value,phone:document.getElementById("updatephone").value,maxNum:document.getElementById("updmaxNum").value,
				lendNum:document.getElementById("updlendNum").value},function (data){
				if(data=="ok"){
					//console.log(uid);
					//console.log(name);
					location.reload();
